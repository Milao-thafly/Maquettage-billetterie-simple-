...
document.querySelectorAll("input[name='classe']").forEach((radio) => {
  radio.addEventListener("input", () => {
    const input = document.getElementById("inputClasse") as HTMLInputElement;
    if (input) {
      input.value = (radio as HTMLInputElement).value;
    }
  });
});
...
document.querySelectorAll("input[name='pays']").forEach((radio) => {
  radio.addEventListener("input", () => {
    const input = document.getElementById("inputPays") as HTMLInputElement;
    if (input) {
      input.value = (radio as HTMLInputElement).value;
    }
  });
